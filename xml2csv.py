    ...
    for event, elem in root:
        ...
        if event == 'start' and elem != first_elem[0]:
            ...
            if len(attributes) > 0:
                ...
                if arg.input_csv or arg.input_csv:
        ...
        elif (arg.input_csv) and event== 'end' and elem.tag != first_elem[0]:
            path_name.pop()

        elif arg.input_csv and event == 'start' and elem.tag == first_elem[0]:
            result_dict_temp = {}
            break
...
def main():
    ...
    if args.input_directory and args.output_attribsTags:
        ...
        csv_to_dict = get_csv(args.input_csv,args) #dataframe containing needed fields
        data = xmlSet()
...
# mac_test >>> python3 xml2csv_7.py -i Data/LDLContent -cc Output/step2_test_xpaths_varietions_master-old.csv -o Output/test_xml2workbench_Nov29.csv
# mac_test >>> python3 xml2csv_7.py -i Data/LDLContent -cc Output/LDL-Xpaths-with-attributes-Nov29.csv -o Output/LDL_WB_output.csv
